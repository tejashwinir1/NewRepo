...
function websdkready() {
  ...
  var CLIENT_ID = "Tg5nde0wKxQZGNrO0QPOhrT4NNW86fTGfOd0";
  /**
   ...
   */
  var CLIENT_SECRET = "OUnQxvom8wyUZs9yxWJxPt8Sok5sfxBousY4";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          meetingConfig.iat = new Date();
          var joinUrl = "https://clapmasterdemo.ulipsu.com/liveclass/join_event?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
